...
window.App = {
  ...
  // Default to Day Mode every time the system is opened
  initTheme() {
  ...
  toggleTheme() {
    ...
    this.showToast(`Switched to ${nextTheme === 'light' ? 'Day Mode' : 'Night Mode'}`, 'info');
  },
  ...
  updateThemeIcon(theme) {
    ...
    if (theme === 'light') {
      ...
      iconBtn.setAttribute('title', 'Switch to Day Mode');
    }
  },
